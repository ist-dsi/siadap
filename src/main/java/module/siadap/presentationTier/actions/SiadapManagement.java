...
public class SiadapManagement extends ContextBaseAction {
    ...
    public final ActionForward setUnitHarmonizationAssessmentData(final ActionMapping mapping, final ActionForm form,
        ...
        try {
            ...
            // getRenderedObject("people-withQuotas-SIADAP2");
            // SiadapUniverseWrapper peopleWithQuotasSiadap3 =
            // (SiadapUniverseWrapper)
            // getRenderedObject("people-withQuotas-SIADAP3");
            // SiadapUniverseWrapper peopleWithoutQuotasSiadap2 =
            // (SiadapUniverseWrapper)
            // getRenderedObject("people-withoutQuotas-SIADAP2");
            ...
            // (List<PersonSiadapWrapper>)
            // getRenderedObject("people-withoutQuotas-SIADAP2id"));
            // }
            ...
            // setHarmonizationCurrentAssessmentFor(SiadapUniverse.SIADAP3,
            // (List<PersonSiadapWrapper>)
            // getRenderedObject("people-withoutQuotas-SIADAP3id"));
            // }
    ...
    private final ActionForward viewUnitHarmonizationData(final ActionMapping mapping, final ActionForm form,
        ...
        // wrapper.getUnitEmployeesWithoutQuotas(false));
    ...
    // private final ActionForward listGlobalEvaluations(final
    // HttpServletRequest request, Predicate predicate) {
    //
    // int year = Integer.parseInt(request.getParameter("year"));
    // Unit unit = getDomainObject(request, "unitId");
    ...
    // unitSiadapWrapper.getUnitEmployees(predicate));
    //
    // return forward(request,
    // "/module/siadap/harmonization/listEvaluations.jsp");
    // }
    //
    // public final ActionForward listHighGlobalEvaluations(final ActionMapping
    // mapping, final ActionForm form,
    // final HttpServletRequest request, final HttpServletResponse response) {
    ...
    // return person.getSiadap() != null && person.isQuotaAware() &&
    // person.getSiadap().hasRelevantEvaluation();
    // }
    //
    // });
    //
    ...
    // public final ActionForward listExcellencyGlobalEvaluations(final
    // ActionMapping mapping, final ActionForm form,
    // final HttpServletRequest request, final HttpServletResponse response) {
    //
    ...
    // PersonSiadapWrapper person = (PersonSiadapWrapper) arg0;
    // return person.getSiadap() != null && person.isQuotaAware() &&
    // person.getSiadap().hasExcellencyAward();
    // }
    //
    // });
    // }
    ...
    // public final ActionForward editExceedingQuotaSuggestion(final
    // ActionMapping mapping, final ActionForm form,
    // final HttpServletRequest request, final HttpServletResponse response) {
    //
    // int year = Integer.parseInt(request.getParameter("year"));
    ...
    // List<SiadapUniverseWrapper> siadapUniverseWrappers =
    // getRenderedObject("siadapUniverseWrappersList");
    //
    // RenderUtils.invalidateViewState();
    //
    // try {
    // for (SiadapUniverseWrapper siadapWrapper : siadapUniverseWrappers) {
    // if (siadapWrapper != null &&
    // siadapWrapper.getSiadapUniverseForSuggestions() != null
    ...
    // siadapWrapper.getSiadapUniverseEnum(),
    // siadapWrapper.getSiadapUniverseForSuggestions().get(0)
    ...
    // }
    //
    // return viewUnitHarmonizationData(mapping, form, request, response, year,
    // unit);
    // }
    ...
    // private final ActionForward prepareAddExceedingQuotaSuggestion(final
    // ActionMapping mapping, final ActionForm form,
    // final HttpServletRequest request, final HttpServletResponse response, int
    // year, UnitSiadapWrapper wrapper,
    ...
    // .getSiadap2AndWorkingRelationWithQuotaUniverse(Boolean.FALSE),
    // SiadapUniverseWrapper.SIADAP2_WITH_QUOTAS,
    // SiadapUniverse.SIADAP2, wrapper, true));
    // siadapUniverseWrappers.add(new SiadapUniverseWrapper(wrapper
    // .getSiadap3AndWorkingRelationWithQuotaUniverse(Boolean.FALSE),
    ...
    private final ActionForward prepareAddExceedingQuotaSuggestion(final ActionMapping mapping, final ActionForm form,
        ...
        // now let's add an emptySuggestionBean - to make possibly to add new
        // suggestions
    ...
    public final ActionForward removeExceedingQuotaProposal(final ActionMapping mapping, final ActionForm form,
        ...
        Unit unit = getDomainObject(request, "unitId");
        int year = Integer.parseInt(request.getParameter("year"));
        // List<SiadapUniverseWrapper> siadapUniverseWrapperList =
        // getRenderedObject("siadapUniverseWrappersList");
    ...
    //
    // public final ActionForward removeExcedingQuotaSuggestion(final
    // ActionMapping mapping, final ActionForm form,
    // final HttpServletRequest request, final HttpServletResponse response) {
    //
