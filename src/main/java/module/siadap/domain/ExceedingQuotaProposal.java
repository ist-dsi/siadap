...
public class ExceedingQuotaProposal extends ExceedingQuotaProposal_Base {
    ...
    public static final Comparator<ExceedingQuotaProposal> COMPARATOR_BY_PRIORITY_NUMBER =
            new Comparator<ExceedingQuotaProposal>() {
                ...
                public int compare(ExceedingQuotaProposal o1, ExceedingQuotaProposal o2) {
                    ...
                    return priorityNumber1.compareTo(priorityNumber2) == 0 ? o1.getExternalId().compareTo(o2.getExternalId()) : priorityNumber1
                            .compareTo(priorityNumber2);
                }
            };
                        ...
                        new Predicate() {
                            ...
                            public boolean evaluate(Object arg0) {
                                ...
                                return (exceedingQuotaProposal.getSiadapUniverse().equals(siadapUniverse)
                                        ...
                                        && exceedingQuotaProposal.getYear() == year && exceedingQuotaProposal.getSuggestionType()
                                        .equals(type));
                            }
    ...
    public static ExceedingQuotaProposal getQuotaProposalFor(final Unit unit, final int year, final Person person,
        ...
        List<ExceedingQuotaProposal> quotaProposalsByPredicate =
                getQuotaProposalsByPredicate(exceedingQuotasProposalsForGivenYear, new Predicate() {
    ...
    public static void createAndAppendProposal(SiadapUniverse siadapUniverse, Boolean quotasApply,
        ...
        List<ExceedingQuotaProposal> currentProposalsForUniverse =
                ExceedingQuotaProposal.getQuotaProposalFor(unitSiadapWrapper.getUnit(), year, siadapUniverse, quotasApply, type);
        int propOrder = 0;
        ...
        new ExceedingQuotaProposal(configuration, person, unitSiadapWrapper.getUnit(), type, propOrder,
                quotasApply.booleanValue(), siadapUniverse);
    ...
    public void remove() {
        ...
        List<ExceedingQuotaProposal> quotaProposalsFor =
                ExceedingQuotaProposal.getQuotaProposalFor(getUnit(), getYear(), getSiadapUniverse(),
                        getWithinOrganizationQuotaUniverse(), getSuggestionType());
