 ...
 * the working relations defined in the configuration ( {@link SiadapYearConfiguration#getWorkingRelation()},
 * {@link SiadapYearConfiguration#getWorkingRelationWithNoQuota()}) to
 * infer the configured defined SiadapHarmonizationRelations {@link SiadapYearConfiguration#getSiadap2HarmonizationRelation()}
