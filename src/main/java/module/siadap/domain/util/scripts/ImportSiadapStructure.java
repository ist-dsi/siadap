...
public class ImportSiadapStructure extends ReadCustomTask {
    ...
    public void doIt() {
        ...
        for (Integer costCenter : avaliators.keySet()) {
            ProcessCostCenter proccessCostCenter =
                    new ProcessCostCenter(costCenter, avaliators.get(costCenter), responsibles, out, costCentersMartelados);
        ...
        for (User user : evaluators) {
            ...
            for (PersonSiadapWrapper evaluatedPerson : evaluatorSiadapWrapper.getPeopleToEvaluate()) {
                ...
                String stringToWrite =
                        evaluatedPerson.getWorkingUnit().getUnit().getAcronym().substring(4) + ","
    ...
    public static class ProcessWorkers extends TransactionalThread {
        ...
        public void transactionalRun() {
            ...
            for (Evaluator evaluator : evaluators) {
                ...
                PartyPredicate parentEvalUnitsCurrentDate =
                        new AccTypeForGivenYearClassPredicate(evaluationRelation, today, Unit.class);
                ...
                for (Evaluated evaluated : evaluator.evaluated) {
                    ...
                    if (evaluatedPerson == null) {
                        ...
                        if (inDevelopmentSystem) {
                            Person p =
                                    Person.create(new MultiLanguageString().with(Language.pt, "DUMMY USER"),
                    ...
                    PartyPredicate workingNoQuotaPartyPredicate =
                            new AccTypeForGivenYearClassPredicate(workingRelationWithNoQuota, today, null);
                    ...
                    if (!adist && !unit.getChildren(workingPartyPredicate).contains(evaluatedPerson)) {
                        evaluatedPerson.addParent(unit, workingRelation, minParentBeginningDateExistence(unit, startOfTheYear),
                                endOfTheYear);
                    }
