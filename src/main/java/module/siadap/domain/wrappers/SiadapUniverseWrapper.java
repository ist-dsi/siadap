...
public class SiadapUniverseWrapper implements Serializable {
    ...
    public SiadapUniverseWrapper(Collection<PersonSiadapWrapper> siadapUniverseOfPeople, String universeDescription,
        ...
        if (universeDisplayMode != null) {
            ...
            case VALIDATION:
                this.excellencyQuota =
                        calculateQuota(this.getNumberTotalRelevantForQuotaPeopleInUniverse(), excellencyQuotaPercentagePoints)
                                .setScale(universeDisplayMode.getScale(), universeDisplayMode.getQuotaRoundingMode());
                this.relevantQuota =
                        calculateQuota(this.getNumberTotalRelevantForQuotaPeopleInUniverse(), relevantQuotaPercentagePoints)
                                .setScale(universeDisplayMode.getScale(), universeDisplayMode.getQuotaRoundingMode());
                break;
            case HARMONIZATION:
            default:
                this.excellencyQuota =
                        calculateQuota(this.getNumberRelevantPeopleInUniverse(), excellencyQuotaPercentagePoints).setScale(
                                universeDisplayMode.getScale(), universeDisplayMode.getQuotaRoundingMode());
                this.relevantQuota =
                        calculateQuota(this.getNumberRelevantPeopleInUniverse(), relevantQuotaPercentagePoints).setScale(
                                universeDisplayMode.getScale(), universeDisplayMode.getQuotaRoundingMode());
                break;
            }
        ...
        case VALIDATION:
            ...
            if (personSiadapWrapper != null) {
                ...
                Map<Integer, Collection<PersonSiadapWrapper>> validationPersonSiadapWrappers =
                        new UnitSiadapWrapper(configuration.getSiadapStructureTopUnit(), configuration.getYear())
                                .getValidationPersonSiadapWrappers(universeToConsider, personSiadapWrapper.isQuotaAware());

                Collection<PersonSiadapWrapper> globalUniverse = validationPersonSiadapWrappers.values().iterator().next();
                this.globalNumberTotalRelevantForQuotaPeopleInUniverse =
                        validationPersonSiadapWrappers.keySet().iterator().next();
                ...
                this.globalExcellencyQuota =
                        calculateQuota(globalNumberTotalRelevantForQuotaPeopleInUniverse, excellencyQuotaPercentagePoints)
                                .setScale(universeDisplayMode.getScale(), universeDisplayMode.getQuotaRoundingMode());
                this.globalRelevantQuota =
                        calculateQuota(globalNumberTotalRelevantForQuotaPeopleInUniverse, relevantQuotaPercentagePoints)
                                .setScale(universeDisplayMode.getScale(), universeDisplayMode.getQuotaRoundingMode());
            } else {
        ...
        this.siadapExceedingQuotaSuggestionsByTypeForUniverse =
                new HashMap<ExceedingQuotaSuggestionType, List<SiadapSuggestionBean>>();
    ...
    private int getCurrentExcellents(Collection<PersonSiadapWrapper> siadapPersonWrappersUniverse, SiadapUniverse siadapUniverse,
        ...
        Predicate predicateToUse =
                new SiadapGradePredicate(considerHarmonizedOnly, siadapUniverse, SiadapGlobalEvaluation.EXCELLENCY,
    ...
    private int getCurrentRelevants(Collection<PersonSiadapWrapper> siadapPersonWrappersUniverse, SiadapUniverse siadapUniverse,
            boolean considerHarmonizedOnly, boolean considerValidatedOnly) {
        Predicate predicateToUse =
                new SiadapGradePredicate(considerHarmonizedOnly, siadapUniverse, SiadapGlobalEvaluation.HIGH,
                        considerValidatedOnly);
        return getNrEvaluationsBasedOnPredicate(siadapPersonWrappersUniverse, predicateToUse);
    ...
    private class SiadapGradePredicate implements Predicate {
        ...
        private boolean hasPositiveValidationAssessment(PersonSiadapWrapper personSiadapWrapper) {
            Siadap siadap = personSiadapWrapper.getSiadap();
            SiadapEvaluationUniverse evaluationUniverse =
                    siadap.getSiadapEvaluationUniverseForSiadapUniverse(siadapUniverseToConsider);
