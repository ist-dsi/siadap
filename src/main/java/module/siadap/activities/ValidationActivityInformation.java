		...
		SET_VALIDATION_DATA {
			...
			public void process(PersonSiadapWrapper personWrapper, SiadapUniverse siadapUniverse) {
				...
				BigDecimal harmonizationClassification =
						siadapEvaluationUniverseForSiadapUniverse.getHarmonizationClassification();
			 ...
			 * <ul>
			 * <li>We can only have an excellent with a grade bigger than 3.999;</li>
			...
			public boolean hasAllneededInfo(PersonSiadapWrapper personWrapper, SiadapUniverse universe) {
				...
				SiadapEvaluationUniverse siadapEvaluationUniverse =
						personWrapper.getSiadap().getSiadapEvaluationUniverseForSiadapUniverse(universe);
				switch (universe) {
				case SIADAP2:
