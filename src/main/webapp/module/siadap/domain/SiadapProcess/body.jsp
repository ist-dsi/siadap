...
<logic:notEmpty name="process" property="siadap.evaluator">
...
<div class="highlightBox"> 
	...
	<logic:empty name="evaluatorPersonWrapper">
		<h3 style="color: darkRed"><b><bean:message bundle="SIADAP_RESOURCES" key="siadapProcess.body.noEvaluator" /></b></h3>
	</logic:empty>
	<logic:notEmpty name="evaluatorPersonWrapper">
