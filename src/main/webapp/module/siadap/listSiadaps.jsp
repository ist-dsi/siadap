...
<div class="infobox">
	<bean:message key="siadap.more.info" bundle="SIADAP_RESOURCES"/> <html:link target="_blank"  href="https://drh.tecnico.ulisboa.pt/tecnicos-e-administrativos/avaliacao-siadap/"> <bean:message key="siadap.more.info.link" bundle="SIADAP_RESOURCES"/></html:link>
</div>
